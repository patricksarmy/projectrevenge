...
download_file("{proff}\\Downloads\\ProjRev\\1.16.1\\projectrevenge.py".format(proff=prof),"https://github.com/patricksarmy/projectrevenge/raw/main/1.16.1/project_revenge_py.py")
